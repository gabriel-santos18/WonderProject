...
public class GroupCommand extends CommandManager {
    ...
    private Rankup lobby;

    public GroupCommand(Rankup lobby) {
                        ...
                        if (!args[0].equalsIgnoreCase(player.getName())) {
                            if (args[1].equalsIgnoreCase("master")) {
                                if (!CustomPlayer.getGroup(player).equalsIgnoreCase("§3GERENTE") && !CustomPlayer.getGroup(player).equalsIgnoreCase("§cADMIN")) {
                                    CustomPlayer.setGroup("§6MASTER", Bukkit.getPlayer(args[0]).getName());
                                    CustomPlayer.setNametag("§6MASTER", Bukkit.getPlayer(args[0]).getName());
                                ...
                                if (!CustomPlayer.getGroup(player).equalsIgnoreCase("§3GERENTE") && !CustomPlayer.getGroup(player).equalsIgnoreCase("§cADMIN")) {
                                    CustomPlayer.setGroup("§3GERENTE", Bukkit.getPlayer(args[0]).getName());
                                    CustomPlayer.setNametag("§3GERENTE", Bukkit.getPlayer(args[0]).getName());
                                ...
                                if (!CustomPlayer.getGroup(player).equalsIgnoreCase("§cADMIN")) {
                                    CustomPlayer.setGroup("§cADMIN", Bukkit.getPlayer(args[0]).getName());
                                    CustomPlayer.setNametag("§cADMIN", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§2MODERADOR", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§2MODERADOR", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§eAJUDANTE", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§eAJUDANTE", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§5WATER", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§5WATER", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§2RAIN", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§2RAIN", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§bCLOUD", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§bCLOUD", Bukkit.getPlayer(args[0]).getName());
                                ...
                                CustomPlayer.setGroup("§7MEMBRO", Bukkit.getPlayer(args[0]).getName());
                                CustomPlayer.setNametag("§7MEMBRO", Bukkit.getPlayer(args[0]).getName());
